...
```
## (参考) DLPEndpooint の RecordType で取れる Opertions の内容
FileDeleted
...
## (参考) 上記 Opertions の内容に含まれる JSON 内の属性全体(Operations の種類によって含まれる情報は異なる)
Application
ClientIP
CreationTime
DeviceName
